<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="neu.cs5200.movieTv.tv.*,neu.cs5200.movieTv.user.*,java.util.*"%>
...
<body>
	<%
		...
		List<Tv> newTvs = tvJws.findPopularTvs();
	...
	<div class="container">
		<div class="masthead">
			<h3 class="text-muted">Most popular Tvs</h3>
			<div role="navigation">
				<ul class="nav nav-tabs">
					...
					<li><a href="/MovieTvApp/onTheAirTvs.jsp?userId=<%=userId%>">On
							the Air Tv</a></li>
					<li><a href="/MovieTvApp/topRatedTv.jsp?userId=<%=userId%>">Top
							rated Tv</a></li>
			...
			<div class="col-xs-6 col-md-3">
				<div class="thumbnail">
					...
					<div class="caption">
						<%=tv.getOriginalName()%>
						<h4>
							Release Date:<%=tv.getFirstAirDate()%></h4>
						<a
							href="/MovieTvApp/tvInfo.jsp?tvId=<%=tv.getId()%>&userId=<%=userId%>"
