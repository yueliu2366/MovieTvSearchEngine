...
<%	
	...
	String urlApi ="http://api.themoviedb.org/3/movie/top_rated?api_key=cb308fc308a03542532cff9b7c2ed4d9";	
...
<ul class="nav nav-tabs">
	<!-- <li role="presentation" class="active"><a href="#">Popular Movie</a></li> -->
  	...
  	<li role="presentation" class="active"><a href="#">Top Rated Movie</a></li>
